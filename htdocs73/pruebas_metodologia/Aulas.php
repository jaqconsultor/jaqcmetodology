...
class Aulas extends CI_Controller
{
    ...
    public function capitulos()
    {
        ...
        // Leer Datos del Query
        $sql = 'SELECT m.* FROM materias_capitulos m order by m.cod_capitulo';
        $query = $this->db->query($sql);
    ...
    public function temas()
    {
        ...
        // Leer Datos del Query
        $sql = 'SELECT m.* FROM tema_videos_ejercicios m order by m.cod_tema';
        $query = $this->db->query($sql);
        $data['datos'] = $query->result_array();
...
//				echo $this->upload->data('file_name');
    ...
    public function respuestas()
    {
        ...
        // Leer Datos del Query
        $sql = 'SELECT m.* FROM evalua_matematicas_resp m where id_evalua_matematicas = 1 order by m.id';
        $query = $this->db->query($sql);
        $data['datos'] = $query->result_array();
