                    ...
                    <div class="table-responsive table-responsive">
                      <table class="table table-striped" id="table-10">
                        ...
                        <tr>
                            ...
                            <td><?php echo $news_item['nb_empresa']; ?></td>
                            <td><strong><?php echo $news_item['No_Imported']; ?></strong></td>
                            <td><?php echo $news_item['No_Douaniere']; ?></td>
                            <td><strong><?php echo $news_item['Membership']; ?></strong></td>
                            <td><?php echo $news_item['TPS']; ?></td>
                        </tr>
                    <?php endforeach ?>
