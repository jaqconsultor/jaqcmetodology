                  ...
                  <div class="card-body">
                    <div class="table-responsive table-responsive">
                      <table class="table table-striped" id="table-10">
                        <thead>
                          <tr>
                            <th class="text-center">Nro de Control</th>
                            <th>Fecha Factura</th>
                            <th>Action</th>
                          </tr>
                        </thead>
                        ...
                        <tr>
                            <td><strong><?php echo $news_item['nu_control']; ?></strong></td>
                            <td><?php echo $news_item['fe_factura']; ?></td>
                            <td>

                            <a type="button" class="btn btn-primary" href="<?php echo site_url('datos/datosFormulario') . "/" . $news_item['nu_control']; ?>">Editar</a>
