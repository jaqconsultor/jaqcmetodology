...
<!-- CSS Libraries -->
<link rel="stylesheet"
	href="<?php echo base_url();?>recursos/node_modules/bootstrap-social/bootstrap-social.css">
...
<div class="login-brand">
								<img src="<?php echo base_url();?>recursos/assets/img/avatar/avatar-1.png" alt="logo"
						...
						<div class="card card-primary">
							<div class="card-header">
								...
								<h4>Credenciales para Acceder</h4>
							</div>

							<div class="card-body">
								<form method="POST" action="<?php echo site_url('inicio/layoutBlank'); ?>" class="needs-validation"
									novalidate="">
									...
									<div class="form-group">
										<div class="d-block">
											...
											<div class="float-right">
												<a href="<?php echo site_url('inicio/olvidoContrasena'); ?>" class="text-small">
													Olvido su Clave? </a>
											</div>
										</div>
									...
									<div class="form-group">
										<button type="submit" class="btn btn-primary btn-lg btn-block"
											tabindex="4">Acceder</button>
									</div>
								</form>
							</div>
						</div>
						<div class="mt-5 text-muted text-center">
							 <a href="<?php echo site_url('inicio/registroDeUsuario'); ?>">Registrate Aquí</a>
						</div>
